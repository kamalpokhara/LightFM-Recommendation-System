...
import json
 ...
 # _export are the csv files exported from the deployed database,
# 1 load prod
...
print(products.head(20)[[ #export csv as name instead of title for product
...
# 4 save
popular.to_csv("retrained_popular_products.csv", index=False)
top20_ids= popular.head(20)["product_id"].tolist()
joblib.dump(top20_ids, "models/retrained_popular_products.pkl")
...
with open("models/retrained_popular_products_meta.json", "w") as f:
    json.dump(meta, f, indent=2)

print("\nSaved:")
print("  data/processed/retrained_popular_products.csv")
print("  models/retrained_popular_products.pkl")
print("  models/retrained_popular_products_meta.json")
